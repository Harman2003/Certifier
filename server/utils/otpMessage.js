const otpMessage = (otp) => `<!DOCTYPE html>
...
<p style="margin: 0; word-break: break-word;"><span style="color: #2b303a;"><strong>Verify your email with the activation code</strong></span></p>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0; word-break: break-word;"><span style="color: #808389;">Welcome to Certify</span></p>
<p style="margin: 0; word-break: break-word;"><span style="color: #808389;">Create, Save and Validate your Certificates</span></p>
</div>
</td>
</tr>
</table>
...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f3fafa; color: #000; width: 640px; margin: 0 auto;" width="640">
<tbody>
<tr>
...
<div style="color:#bfbfc4;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:12px;line-height:150%;text-align:left;mso-line-height-alt:18px;">
<p style="margin: 0;">This is an automated email. <br/>Certify empowers organizations to create secure certificates using blockchain technology, while enabling users to maintain a digital locker for securely storing their certificates. Our blockchain-powered platform allows anyone to validate certificates at any time.</p>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0; word-break: break-word;"><span style="color: #95979c;">Certify Copyright © 2023</span></p>
</div>
</td>
</tr>
</table>
