...
const WalletButton = () => {
  ...
  return (
    <div className="h-10">
      {address ? (
        <button
          className="border-[1px] border-black px-6 h-10 rounded-full flex gap-2 items-center font-Nunito relative group"
          onClick={copyAddress}
        ...
        >
          ...
          {/* copy Address popup */}
          <div className="hidden absolute top-[26px] bg-popup bg-cover w-[152px] h-[46px] group-hover:flex items-center justify-center popup">
